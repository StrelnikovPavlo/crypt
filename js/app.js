(() => {
    ...
    function initSliders() {
        if (document.querySelector(".main-mainscreen__column-slider")) new Swiper(".main-mainscreen__column-slider", {
            ...
            crossFade: true,
            pagination: {
                el: ".main-mainscreen__pagination",
                clickable: true
            },
            autoplay: {
                delay: 2e3,
        ...
        if (document.querySelector(".risks__link")) new Swiper(".risks__link", {
